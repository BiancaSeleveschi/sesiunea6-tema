...
let b = 4;
let prod = a * b;
console.log("Produsul este " + prod)
...
console.log("Totalul secundelor este " + MinutesToSeconds)
...
console.log("Numarul anilor in zile este " + years)
...
console.log("Totalul secundelor este " + hoursToSeconds)
...
// let number = 6
// function verifyStringLength(string, number) {
...
let allowedToDrive = isAllowedToDrive(age, hasDriverLicense);
...
let shoudIDo = whatShouldIDo(isSunny, isHoliday, remainingFreeTime);

//Scri o functie care primeste 3 parametri: firstName, lastName and age si returneaza stringul compus din cele 3: “My name is: firstName + lastName and I am age years old”
...
let personalDescription1 = composePersonalDescription(firstName, lastName, age1);
